...
namespace PrimeSimulateur.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public IActionResult Simuler(int id)
        {
            ViewData["prime"] = CalculerPrime(id);

            return View();
        }

        private float CalculerPrime(int travailId)
        {  
            ...
            //pour le fichier csv 
            _context.trace.AddAsync(new trace { Nom = travail.Name, Surface = travail.surface, Type = categorie.type, ClientId = client.ClientId, prime=prime, });
